...
def args_test():
    ...
    #
    assembly, cov_file = read_inputs("/Users/MaddisonLab/Documents/JMP/DeconMachine/test_set_in.txt",
...
def _generate_exonerate_cmd(query, target, hits, out_file, score_min, model="est2genome"):
    command = "while true; do exonerate {} {} -m {} -n {} --score {} --extensionthreshold 1000 --ryo \">%qi %ti_TrimLen=%tal_Cord=%tab_%tae\\n%ts\" --verbose 0 --showalignment no --showvulgar no > {} && break ; sleep 10; done".format(
