...
def args_test_quick2():  # Mini test set with Siagona
    ...
    dmnd_db = "/Users/MaddisonLab/Documents/JMP/DeconMachine/swissprot_plus_taxonomy.dmnd"
    # dmnd_db = "/Users/maddisonlab/Documents/James/DeconMachine/uniref50_24.dmnd"
...
def score(df_in):
    ...
    exdf.loc[exdf.groupby(['Ref'])['ExonerateScore'].idxmax(), 'TopExScore'] = True
    ...
    exdf.loc[(exdf['Tag'] == "HIGHCOV") & (exdf['TopExScore'] == True), 'Tag'] = "HIGHCOV*HiScr"
    exdf.loc[(exdf['Tag'] == "LONGEST") & (exdf['TopExScore'] == True), 'Tag'] = "LONGEST*HiScr"
...
if use_uniref:
    ...
    start = time.time()
    uniref_id_dict = open_gz_fasta(uniref50_fasta, return_id_dict=True)
    end = time.time()
    run_time = end - start
